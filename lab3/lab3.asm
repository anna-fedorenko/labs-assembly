...
m1:                 ;мітка циклу
 ...
 loop m1            ;кінець циклу
    ...
    invoke FpuFLtoA,offset _y1,10,offset _res1,SRC1_REAL or SRC2_DIMM       ;конвертування значення _y1 у формат десяткового числа з плаваючою комою та запис його у змінну _res1
	mov word ptr _res1 + 14, CrLf                                           ;додавання символів переносу рядка до рядка _res1
	invoke FpuFLtoA,offset _y2,10,offset _res2,SRC1_REAL or SRC2_DIMM       ;конвертування _y2 у десятковий формат з плаваючою комою та запис його у _res2
	mov word ptr _res2 + 14, CrLf                                           ;додавання символів переносу рядка до рядка _res2
	invoke FpuFLtoA,offset _y3,10,offset _res3,SRC1_REAL or SRC2_DIMM       ;конвертування _y3 у десятковий формат з плаваючою комою та запис його у _res3
	mov word ptr _res3 + 14, CrLf                                           ;додавання символів переносу рядка до рядка _res3
	invoke FpuFLtoA,offset _y4,10,offset _res4,SRC1_REAL or SRC2_DIMM       ;конвертування _y4 у десятковий формат з плаваючою комою та запис його у _res4
	mov word ptr _res4 + 14, CrLf                                           ;додавання символів переносу рядка до рядка _res4
	invoke FpuFLtoA,offset _y5,10,offset _res5,SRC1_REAL or SRC2_DIMM       ;конвертування _y5 у десятковий формат з плаваючою комою та запис його у _res5
    mov word ptr _res5 + 14, CrLf                                           ;додавання символів переносу рядка до рядка _res5
	invoke FpuFLtoA,offset _y6,10,offset _res3,SRC1_REAL or SRC2_DIMM       ;конвертування _y6 у десятковий формат з плаваючою комою та запис його у _res6
	mov word ptr _res6 + 14, CrLf                                           ;додавання символів переносу рядка до рядка _res6
	invoke FpuFLtoA,offset _y7,10,offset _res4,SRC1_REAL or SRC2_DIMM       ;конвертування _y7 у десятковий формат з плаваючою комою та запис його у _res7
	mov word ptr _res7 + 14, CrLf                                           ;додавання символів переносу рядка до рядка _res7
	invoke FpuFLtoA,offset _y8,10,offset _res5,SRC1_REAL or SRC2_DIMM       ;конвертування _y8 у десятковий формат з плаваючою комою та запис його у _res8
